...
def get_roster_scraping_selection() -> list[str]:
    roster_prompt_text = "Input the abbreviations for the teams whose rosters should be saved. Check the resources folder to see a list of team abbreviations."
...
def get_team_stats_scraping_selection() -> list[str]:
    roster_prompt_text = "Input the abbreviations for the teams whose players' stats should be saved. Check the resources folder to see a list of team abbreviations."
...
def choose_year() -> int:
    ...
    while (not year_input.isdigit()) or (int(year_input) > int(utils.get_current_year())):
        year_input = input("Input year to gather data from: ")
    print()
